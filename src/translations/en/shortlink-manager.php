...
return [
    ...
    // Controller messages
    'Failed {label}: configured template path cannot be copied.' => 'Failed {label}: configured template path cannot be copied.',
    ...
    'Some frontend templates are missing. Open <a href="{url}">setup</a> for guided copy instructions before creating public short links or QR landing pages.' => 'Some frontend templates are missing. Open <a href="{url}">setup</a> for guided copy instructions before creating public short links or QR landing pages.',
    ...
    'Direct Redirect is active. The redirect template is only used when Direct Redirect is disabled. Open <a href="{url}">Behavior settings</a> to change this.' => 'Direct Redirect is active. The redirect template is only used when Direct Redirect is disabled. Open <a href="{url}">Behavior settings</a> to change this.',
...
• Recommended to keep enabled for production sites',
    ...
    'Missing' => 'Missing',
    'Bundled template:' => 'Bundled template:',
    ...
    '{pluginName} is ready to create public short links and QR landing pages.' => '{pluginName} is ready to create public short links and QR landing pages.',
