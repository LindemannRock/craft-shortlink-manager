...
return [
    ...
    'Servd static cache purge queued.' => 'Servd static cache purge queued.',
    'Servd static cache is not available.' => 'Servd static cache is not available.',
    'QR code cache cleared successfully.' => 'QR code cache cleared successfully.',
    'Cleared {count, plural, =1{# QR code cache} other{# QR code caches}}.' => 'Cleared {count, plural, =1{# QR code cache} other{# QR code caches}}.',
    'Device cache cleared successfully.' => 'Device cache cleared successfully.',
    'Cleared {count, plural, =1{# device cache} other{# device caches}}.' => 'Cleared {count, plural, =1{# device cache} other{# device caches}}.',
    'All caches cleared successfully.' => 'All caches cleared successfully.',
    'Cleared {qrCount, plural, =1{# QR code cache} other{# QR code caches}} and {deviceCount, plural, =1{# device cache} other{# device caches}}.' => 'Cleared {qrCount, plural, =1{# QR code cache} other{# QR code caches}} and {deviceCount, plural, =1{# device cache} other{# device caches}}.',
    ...
    'Invalid destination URL (must start with https://, http://, or /)' => 'Invalid destination URL (must start with https://, http://, or /)',
    'Code/slug already exists' => 'Code/slug already exists',
    'Duplicate row for same code and site' => 'Duplicate row for same code and site',
    ...
    'Changing will break existing URLs. To migrate, redirect the old shortlink prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-prefix/*\' → Destination \'{destinationExample}\'.' => 'Changing will break existing URLs. To migrate, redirect the old shortlink prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-prefix/*\' → Destination \'{destinationExample}\'.',
    ...
    'These templates must exist in your site\'s <code>templates/</code> folder at the paths configured below. Copy each matching reference template into its configured destination and customize as needed.' => 'These templates must exist in your site\'s <code>templates/</code> folder at the paths configured below. Copy each matching reference template into its configured destination and customize as needed.',
    ...
    'Required: copy <code>{source}</code> to <code>{destination}</code>' => 'Required: copy <code>{source}</code> to <code>{destination}</code>',
    ...
    'Direct Redirect can be cached by browsers, CDNs, and static cache layers. If every hit must be tracked, configure cache bypass rules for your shortlink routes. With the current prefixes, start with: {routeExamples}. {followup}' => 'Direct Redirect can be cached by browsers, CDNs, and static cache layers. If every hit must be tracked, configure cache bypass rules for your shortlink routes. With the current prefixes, start with: {routeExamples}. {followup}',
    'Direct Redirect can be cached by browsers, CDNs, and static cache layers. Root-level short links are active, for example <code>/abc123</code> and <code>/{siteHandle}/abc123</code>, so use carefully scoped cache rules and use Direct Redirect carefully under static cache. QR routes still use: {routeExamples}. {followup}' => 'Direct Redirect can be cached by browsers, CDNs, and static cache layers. Root-level short links are active, for example <code>/abc123</code> and <code>/{siteHandle}/abc123</code>, so use carefully scoped cache rules and use Direct Redirect carefully under static cache. QR routes still use: {routeExamples}. {followup}',
    'Servd Static Cache is available. Use Utilities → ShortLink Manager → Servd Static Cache after changing this setting; Servd may briefly serve stale responses while purging or revalidating.' => 'Servd Static Cache is available. Use Utilities → ShortLink Manager → Servd Static Cache after changing this setting; Servd may briefly serve stale responses while purging or revalidating.',
    'Clear any browser, CDN, or static cache before retesting redirect-mode changes.' => 'Clear any browser, CDN, or static cache before retesting redirect-mode changes.',
    ...
    'Perform a server-side redirect without rendering a template. SEOmatic client-side tracking (GTM/GA events) will not fire, and server-side analytics only run when the request reaches Craft/PHP.' => 'Perform a server-side redirect without rendering a template. SEOmatic client-side tracking (GTM/GA events) will not fire, and server-side analytics only run when the request reaches Craft/PHP.',
    ...
    'Cache duration in seconds. Current: <strong id="qrCodeCacheDuration-human"></strong>' => 'Cache duration in seconds. Current: <strong id="qrCodeCacheDuration-human"></strong>',
...
• Recommended to keep enabled for production sites',
    ...
    'Choose a product as the destination' => 'Choose a product as the destination',
    'Choose a product' => 'Choose a product',
    'Select Variant' => 'Select Variant',
    'Choose a product variant as the destination' => 'Choose a product variant as the destination',
    ...
    'Delete {count} folder? This will also unassign it from linked shortlinks.' => 'Delete {count} folder? This will also unassign it from linked shortlinks.',
    'Delete {count} folders? This will also unassign them from linked shortlinks.' => 'Delete {count} folders? This will also unassign them from linked shortlinks.',
    'Delete {count} tag?' => 'Delete {count} tag?',
    'Delete {count} tags?' => 'Delete {count} tags?',
    'Used by' => 'Used by',
    ...
    // Import/Export
    'Import {count} shortlink(s)?' => 'Import {count} shortlink(s)?',
    ...
    'No traffic type data available for the selected filters.' => 'No traffic type data available for the selected filters.',
    ...
    'Queue a Servd purge for all public {linksName} URLs and QR landing pages. This does not clear Craft’s cache or other plugins’ caches.' => 'Queue a Servd purge for all public {linksName} URLs and QR landing pages. This does not clear Craft’s cache or other plugins’ caches.',
    'Purge Servd Static Cache' => 'Purge Servd Static Cache',
    'Purge Servd static cache for all {linksName}?' => 'Purge Servd static cache for all {linksName}?',
    ...
    'IP salt' => 'IP salt',
    'Analytics needs a privacy salt before public link tracking is ready.' => 'Analytics needs a privacy salt before public link tracking is ready.',
    'Analytics privacy salt is ready for public link tracking.' => 'Analytics privacy salt is ready for public link tracking.',
    'IP hash salt is configured.' => 'IP hash salt is configured.',
    'Starter templates are missing.' => 'Starter templates are missing.',
    'Starter template is missing.' => 'Starter template is missing.',
    'Starter templates' => 'Starter templates',
    'All required frontend templates are available.' => 'All required frontend templates are available.',
    'Starter templates are ready.' => 'Starter templates are ready.',
    'Copy the starter templates before public short links can render their frontend pages.' => 'Copy the starter templates before public short links can render their frontend pages.',
    'Copy the missing starter template before public links can render this frontend page.' => 'Copy the missing starter template before public links can render this frontend page.',
    'Copy the missing starter templates before public links can render redirect, expired, or QR pages.' => 'Copy the missing starter templates before public links can render redirect, expired, or QR pages.',
    'Run this command in your terminal:' => 'Run this command in your terminal:',
    'Run these commands in your terminal:' => 'Run these commands in your terminal:',
    'Review and customize the copied templates before going live.' => 'Review and customize the copied templates before going live.',
    'Setup incomplete' => 'Setup incomplete',
    'Finish setup before creating public short links and QR landing pages.' => 'Finish setup before creating public short links and QR landing pages.',
    'Open setup' => 'Open setup',
    'Setup complete.' => 'Setup complete.',
    'ShortLink Manager is ready to create public short links and QR landing pages.' => 'ShortLink Manager is ready to create public short links and QR landing pages.',
