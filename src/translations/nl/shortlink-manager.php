...
return [
    ...
    'Changing will break existing URLs. To migrate, redirect the old shortlink prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-prefix/*\' → Destination \'{destinationExample}\'.' => 'Wijzigen verbreekt bestaande URLs. Om te migreren, stuurt u het oude shortlinkprefix door naar het nieuwe in uw redirecttool, CDN of serverconfiguratie, bijvoorbeeld: Bron \'/old-prefix/*\' → Bestemming \'{destinationExample}\'.',
    'Changing will break existing QR URLs. To migrate, redirect the old QR prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-qr-prefix/*\' → Destination \'{destinationExample}\'. Supports standalone (e.g., \'qr\') or nested (e.g., \'s/qr\') patterns.' => 'Wijzigen verbreekt bestaande QR-URLs. Om te migreren, stuurt u het oude QR-prefix door naar het nieuwe in uw redirecttool, CDN of serverconfiguratie, bijvoorbeeld: Bron \'/old-qr-prefix/*\' → Bestemming \'{destinationExample}\'. Ondersteunt zelfstandige (bijv. \'qr\') of geneste (bijv. \'s/qr\') patronen.',
    ...
    'Some frontend templates are missing. Open <a href="{url}">setup</a> for guided copy instructions before creating public short links or QR landing pages.' => 'Sommige frontendtemplates ontbreken. Open de <a href="{url}">setup</a> voor begeleide kopieerinstructies voordat u openbare korte links of QR-landingspagina\'s maakt.',
    ...
    'Direct Redirect is active. The redirect template is only used when Direct Redirect is disabled. Open <a href="{url}">Behavior settings</a> to change this.' => 'Directe doorverwijzing is actief. Het doorverwijzingssjabloon wordt alleen gebruikt wanneer directe doorverwijzing is uitgeschakeld. Open de <a href="{url}">Gedragsinstellingen</a> om dit te wijzigen.',
    ...
    'Track clicks and visitor data for {pluralLowerName}. When enabled, {pluginName} will track visitor interactions, device types, geographic data, and other analytics information.' => 'Klikken en bezoekersgegevens bijhouden voor {pluralLowerName}. Wanneer ingeschakeld, zal {pluginName} bezoekerinteracties, apparaattypen, geografische gegevens en andere analyse-informatie bijhouden.',
...
• Aanbevolen ingeschakeld te houden voor productiesites',
    ...
    '{pluginName} is ready to create public short links and QR landing pages.' => '{pluginName} is gereed om openbare korte links en QR-landingspagina\'s te maken.',
