...
final class PostgresDialectSafetyTest extends TestCase
{
    ...
    private const BOOLEAN_COLUMNS = [
        'anonymizeIpAddress', 'cacheDeviceDetection', 'directRedirect', 'enableAnalytics',
        'enableGeoDetection', 'enableQrCodeCache', 'enableQrDownload', 'enableQrLogo', 'exportsCsv',
        'exportsExcel', 'exportsJson', 'isMobileApp', 'isRobot', 'isSystemAgent', 'passQueryParams',
        'qrCodeEnabled', 'showSeconds', 'trackAnalytics', 'usePrefix',
    ];
